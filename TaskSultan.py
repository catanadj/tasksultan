...
level_colors = ['bright_red', 'bright_green', 'bright_yellow', \
                 'bright_blue', 'bright_magenta', 'bright_cyan', 'bright_white']
guide_styles = ['red', 'green', 'yellow', 'blue', \
                 'magenta', 'cyan', 'white']
    ...
    def search_project(project_list):
        ...
        while True:
            ...
            if choice == 'R':
                ...
                display_tasks(f"task project:{item_name} +PENDING export",show_details=True)
            elif choice == 'RD':
